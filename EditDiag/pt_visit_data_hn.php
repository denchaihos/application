...
$data = array();
if($visit_type == 'O'){
    $sql ='select od.id as id_dx,concat(p.fname," ",p.lname) as ptname,o.hn,time(o.vstdttm) as vstdttm,od.icd10,od.cnt,o.vn from ovst o left outer join ovstdx od on od.vn=o.vn
    ...
    $sql = 'select idx.id as id_dx,concat(p.fname," ",p.lname) as ptname,i.hn,time(i.dchdate) as vstdttm,idx.icd10,idx.itemno as cnt,i.vn
